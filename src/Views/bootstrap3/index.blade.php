...
@section('footer')
	<script src="https://cdn.datatables.net/v/bs/dt-{{ Ticket\Ticketit\Helpers\Cdn::DataTables }}/r-{{ Ticket\Ticketit\Helpers\Cdn::DataTablesResponsive }}/datatables.min.js"></script>
	<script>
	    $('.table').DataTable({
	        processing: false,
	        serverSide: true,
