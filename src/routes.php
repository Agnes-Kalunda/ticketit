...
Route::group(['middleware' => \Ticket\Ticketit\Helpers\LaravelVersion::authMiddleware()], 
    ...
    //Ticket public route
    Route::get("$main_route_path/complete", 'Ticket\Ticketit\Controllers\TicketsController@indexComplete')
            ->name("$main_route-complete");
    Route::get("$main_route_path/data/{id?}", 'Ticket\Ticketit\Controllers\TicketsController@data')
            ->name("$main_route.data");

    $field_name = last(explode('/', $main_route_path));
    Route::resource($main_route_path, 'Ticket\Ticketit\Controllers\TicketsController', [
            'names' => [
    ...
    Route::get("$main_route_path/{id}/complete", 'Ticket\Ticketit\Controllers\TicketsController@complete')
            ->name("$main_route.complete");

    //Ticket reopen route for permitted user.
    Route::get("$main_route_path/{id}/reopen", 'Ticket\Ticketit\Controllers\TicketsController@reopen')
    ...
    Route::group(['middleware' => 'Ticket\Ticketit\Middleware\IsAdminMiddleware'], function () use ($admin_route, $admin_route_path) {
        ...
        Route::get("$admin_route_path/indicator/{indicator_period?}", [
                ...
                'uses' => 'Ticket\Ticketit\Controllers\DashboardController@index',
        ]);
        Route::get($admin_route_path, 'Ticket\Ticketit\Controllers\DashboardController@index');

        //Ticket statuses admin routes (ex. http://url/tickets-admin/status)
        Route::resource("$admin_route_path/status", 'Ticket\Ticketit\Controllers\StatusesController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/priority", 'Ticket\Ticketit\Controllers\PrioritiesController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/agent", 'Ticket\Ticketit\Controllers\AgentsController', [
            'names' => [
        ...
        //Agents management routes (ex. http://url/tickets-admin/agent)
        Route::resource("$admin_route_path/category", 'Ticket\Ticketit\Controllers\CategoriesController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/configuration", 'Ticket\Ticketit\Controllers\ConfigurationsController', [
            'names' => [
        ...
        Route::resource("$admin_route_path/administrator", 'Ticket\Ticketit\Controllers\AdministratorsController', [
            'names' => [
        ...
        // Route::get("$admin_route/demo-seeds", 'Ticket\Ticketit\Controllers\InstallController@demoDataSeeder');
    });
});
